...
public class PedidoController {
	...
	@PostMapping("pedido/{idPedido}/item")
	public ResponseEntity<Pedido> addItemInPedido(@PathVariable(value = "idPedido") Long idPedido, @RequestBody Produto produto, UriComponentsBuilder builder) {
